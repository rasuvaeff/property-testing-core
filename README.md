...
| [`rasuvaeff/property-testing-openapi`](https://github.com/rasuvaeff/property-testing-openapi) | You have an OpenAPI document and want property-based contract tests for the API behind it: generated valid and negative requests, an operation suite, and pre-transport validity oracles over [`rasuvaeff/openapi-contract`](https://github.com/rasuvaeff/openapi-contract) |
