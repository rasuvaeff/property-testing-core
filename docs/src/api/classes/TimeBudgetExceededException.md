...
description: "Thrown (as the failure of a property) when the random phase's wall-clock time exceeds the Runner\\PropertyConfig::$budgetMs budget before the requested…"
---
