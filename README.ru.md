...
персональные либо похожие на учётные данные, запишет ровно их на диск
открытым JSON. Держите каталог вне общедоступных путей и вне публикуемых
...
Если корпус всё же включён — помните, что он сохраняет падающие входы
открытым JSON: что это значит для генераторов, способных произвести
