...
const sidebar = [
    ...
    { text: 'Shrinking', link: '/guide/shrinking' },
    {
        ...
        items: [
            ...
            { text: 'Composite generators', link: '/guide/generators/composite' },
            { text: 'Shrinkable randomness', link: '/guide/generators/randomness' },
            { text: 'Swarm testing', link: '/guide/generators/swarm' },
            { text: 'Generating from a class', link: '/guide/generators/from-a-class' },
    ...
    },
    {
        ...
        items: [
            ...
            { text: 'Exhaustive mode', link: '/guide/controlling-runs/exhaustive' },
            { text: 'Flaky detection', link: '/guide/controlling-runs/flaky' },
        ],
    },
    ...
    { text: 'Targeted search', link: '/guide/targeted-search' },
    { text: 'Sampling & export', link: '/guide/sampling-and-export' },
    {
        ...
        items: [
            ...
            { text: 'Rule-based machines', link: '/guide/state-machine/rules' },
        ],
    },
