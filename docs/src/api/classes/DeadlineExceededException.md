...
description: "Thrown (as the failure of a property) when a single run's body takes longer than the Runner\\PropertyConfig::$timeoutMs deadline."
---
...
**Class** — **Package:** [property-testing-core](https://github.com/rasuvaeff/property-testing-core) — [Source](https://github.com/rasuvaeff/property-testing-core/blob/master/src/DeadlineExceededException.php#L21) — **Version:** working tree
